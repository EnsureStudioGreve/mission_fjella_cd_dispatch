...
Config.InfiltrationPoints = { vec3(-138.64, 6147.55, 32.78), vec3(-68.86, 6267.75, 31.12)  }
Config.ObjectivePoints    = { vec3(-86.57, 6212.91, 30.18) }
Config.DeliveryPoints     = { vec3(1515.91, 6333.32, 24.11) }
...
Config.SnitchPed = {
    ...
    heading = 201.68,
    targetLabel = 'Get message if something happens',
    smsFrom  = 'Snitch',
...
Config.Buyer = {
    ...
    blipName = 'Buyer',
    notify = 'Get outta there!'
}

Config.CarryBox = {
    blockVehicle = true,
    anim = { dict = 'anim@heists@box_carry@', clip = 'idle', flag = 51 },
    prop = {
        bone = 60309,
